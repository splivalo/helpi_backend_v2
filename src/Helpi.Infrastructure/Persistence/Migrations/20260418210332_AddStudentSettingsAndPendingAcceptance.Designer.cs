...
namespace Helpi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260418210332_AddStudentSettingsAndPendingAcceptance")]
    partial class AddStudentSettingsAndPendingAcceptance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Helpi.Domain.Entities.ChatRoom", b =>
                {
                    ...
                    b.Property<string>("Participant1Role")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<int>("Participant1UserId")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("Participant2Role")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<int>("Participant2UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Helpi.Domain.Entities.CouponUsage", b =>
                {
                    ...
                    b.Property<int>("CouponAssignmentId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Helpi.Domain.Entities.JobInstance", b =>
                {
                    ...
                    b.Property<string>("HangFireRemindStudentJobId")
                        .HasColumnType("text");
                    ...
                    b.Property<decimal>("StudentHourlyRate")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Helpi.Domain.Entities.PaymentTransaction", b =>
                {
                    ...
                    b.Property<int>("InvoiceCreationStatus")
                        .HasColumnType("integer");

                    b.Property<byte>("InvoiceRetryCount")
                        .HasColumnType("smallint");
                    ...
                    b.Property<int?>("MinimaxInvoiceId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Helpi.Domain.Entities.PricingChangeHistory", b =>
                {
                    ...
                    b.Property<decimal>("NewSundayHourlyRate")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal>("OldSundayHourlyRate")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Helpi.Domain.Entities.PricingConfiguration", b =>
                {
                    ...
                    b.Property<int>("AvailabilityChangeCutoffHours")
                        .HasColumnType("integer");

                    b.Property<bool>("AvailabilityChangeEnabled")
                        .HasColumnType("boolean");

                    b.Property<decimal>("CompanyPercentage")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("IntermediaryPercentage")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("JobHourlyRate")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("PaymentTimingMinutes")
                        .HasColumnType("integer");

                    b.Property<int>("SeniorCancelCutoffHours")
                        .HasColumnType("integer");

                    b.Property<decimal>("ServiceProviderPercentage")
                        .HasColumnType("decimal(5,2)");

                    b.Property<int>("StudentCancelCutoffHours")
                        .HasColumnType("integer");

                    b.Property<bool>("StudentCancelEnabled")
                        .HasColumnType("boolean");

                    b.Property<decimal>("StudentHourlyRate")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("StudentSundayHourlyRate")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("SundayHourlyRate")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Helpi.Domain.Entities.Sponsor", b =>
                {
                    ...
                    b.Property<Dictionary<string, string>>("Label")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Helpi.Domain.Entities.AdminNote", b =>
                {
                    b.HasOne("Helpi.Domain.Entities.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Helpi.Domain.Entities.ChatMessage", b =>
                {
                    b.HasOne("Helpi.Domain.Entities.ChatRoom", "ChatRoom")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Helpi.Domain.Entities.CouponAssignment", b =>
                {
                    b.HasOne("Helpi.Domain.Entities.Admin", "AssignedByAdmin")
                        .WithMany()
                        .HasForeignKey("AssignedByAdminId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Helpi.Domain.Entities.Coupon", "Coupon")
            ...
            modelBuilder.Entity("Helpi.Domain.Entities.CouponUsage", b =>
                {
                    b.HasOne("Helpi.Domain.Entities.CouponAssignment", "CouponAssignment")
                        .WithMany("Usages")
                        .HasForeignKey("CouponAssignmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Helpi.Domain.Entities.SuspensionLog", b =>
                {
                    b.HasOne("Helpi.Domain.Entities.User", "AdminUser")
                        .WithMany()
