...
VALUES
  ...
  (1, 30, 'Notifications.NewOrder',   'Nova narudzba',      'Kreirana je nova narudzba', false, NOW() - INTERVAL '3 minutes', NULL, 1, 3, NULL, NULL, '{"orderId":3,"seniorId":1}'),
  ...
  (1, 31, 'Notifications.AvailabilityChanged', 'Promjena dostupnosti studenta', 'Ana Horvat, Pogodena narudzba #3 (Pon 09:00-11:00)', false, NOW() - INTERVAL '9 minutes', 101, NULL, 3, NULL, NULL, '{"studentName":"Ana Horvat","orderId":3,"scheduleDescription":"pon 09:00-11:00"}');
